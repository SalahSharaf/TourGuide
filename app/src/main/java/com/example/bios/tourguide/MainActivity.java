...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resources1.add(0);
        resources1.add(0);
        AboutCairoFragment aboutCairoFragment = new AboutCairoFragment(new FragmentModel("About Cairo", getString(R.string.string1) + getString(R.string.string2), resources1, R.drawable.background2));
        ...
        EltahrirFragment eltahrirFragment = new EltahrirFragment(new FragmentModel("El Tahrir Square",getString(R.string.string3),resources2, R.drawable.a80060));
        fragments.add(eltahrirFragment);
        ArrayList<Integer> resources3=new ArrayList<>();
        resources3.add(R.drawable.cairo___islamic);
        resources3.add(0);
        resources3.add(0);
        ALazharFragment aLazharFragment = new ALazharFragment(new FragmentModel("Alazhar", getString(R.string.string4),
        ...
        ThePyramidsFragment thePyramidsFragment = new ThePyramidsFragment(new FragmentModel("The Pyramids of Giza", getString(R.string.string5),
