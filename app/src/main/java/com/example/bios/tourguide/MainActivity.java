...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(new EltahrirFragment(new FragmentModel(  "El tahrir Square", "Tahrir Square\n" +
